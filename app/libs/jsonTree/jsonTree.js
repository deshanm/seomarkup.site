/**
 * JSON Tree Library (part of jsonTreeViewer)
 * https://github.com/summerstyle/jsonTreeViewer
 *
 * Copyright 2017 Vera Lobacheva (http://iamvera.com)
 * Released under the MIT license (LICENSE.txt)
 *
 * This library provides a way to visualize JSON data in a tree format.
 * It supports various data types including objects, arrays, strings, numbers, booleans, and null.
 * The library is designed to be lightweight and easy to integrate into web applications.
 */
var jsonTree = (function() {
    ...
    _NodeSimple.prototype = {
        ...
        markParent : function() {
            this.el.classList.add('highlight-parent');    
        },
         ...
         */
        markChild : function() {
            this.el.classList.add('highlight-child');    
        },
         ...
         */
        unmark : function() {
            this.el.classList.remove('highlight-parent', 'highlight-child');    
        },
    ...
    Tree.prototype = {
        ...
        search: function(searchTerm) {
            ...
            this.findAndHandle(function(node) {
                if (typeof node.label === 'string' && node.label.toLowerCase().includes(searchTerm)) {
                    return true;
                }
                const jsontree_value = node.el.querySelector('.jsontree_value')?.textContent;
                if (jsontree_value.toLowerCase().includes(searchTerm)) {
                    return true;
                }
